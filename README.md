...
Para poder utilizar estos servicios web en QGIS y así poder geolocalizar y descargar todos los elementos almacenados en CartoCiudad, se ha creado este **complemento de QGIS**, que está basado en servicio REST «Geocoder».
 ...
 ![PluginQGIS](PluginQGISCartoCiudad/docs/inicio.png)
...
![Ejemplo busqueda](PluginQGISCartoCiudad/docs/ejemplo_ng.png)
...
![Ejemplo simbología capas](PluginQGISCartoCiudad/docs/simbologia.png)
...
![Ejemplo número capas](PluginQGISCartoCiudad/docs/numeros.png)
...
![Ejemplo busqueda filtro 1](PluginQGISCartoCiudad/docs/filtro1.png)

 *Ejemplo de búsqueda del Instituto Geográfico Nacional del código postal 28003*:
 
![Ejemplo busqueda filtro 2](PluginQGISCartoCiudad/docs/filtro2.png)
...
![Ejemplo busqueda filtro UA](PluginQGISCartoCiudad/docs/filtroUA.png)
...
![Ejemplo busqueda filtro tipo](PluginQGISCartoCiudad/docs/filtrotipo.png)
...
![Ejemplo busqueda filtro 2](PluginQGISCartoCiudad/docs/Busquedacoordenadas.png)
